...
public class createcategory extends javax.swing.JInternalFrame {
...
catch(SQLException ex)
{
    ...
    private void initComponents() {
        ...
        jDesktopPane2.add(textField1);
        textField1.setBounds(0, 0, 60, 20);
    ...
    String  c=jTextField2.getText();
      ...
      String cmd="insert into category_page(Category_name) values('"+c+"')";
