...
public class stockinn extends javax.swing.JInternalFrame {
Connection con;
ResultSet rs;
Statement st;
    ...
    public void setCombo()
{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String cmd="insert into stockin(Item,Date,Quantity) values('"+t+"','"+d+"','"+c+"')";
 ...
 // String  e= buttonGroup1.getSelection().getActionCommand();